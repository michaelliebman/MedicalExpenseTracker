...
import com.github.msl521.met.domain.PaymentDataOnDemand;
...
privileged aspect PaymentIntegrationTest_Roo_IntegrationTest {
    ...
    public void PaymentIntegrationTest.testCountPayments() {
        ...
        long count = com.github.msl521.met.domain.Payment.countPayments();
    ...
    public void PaymentIntegrationTest.testFindPayment() {
        com.github.msl521.met.domain.Payment obj = dod.getRandomPayment();
        ...
        obj = com.github.msl521.met.domain.Payment.findPayment(id);
    ...
    public void PaymentIntegrationTest.testFindAllPayments() {
        ...
        java.util.List<com.github.msl521.met.domain.Payment> result = com.github.msl521.met.domain.Payment.findAllPayments();
    ...
    public void PaymentIntegrationTest.testFindPaymentEntries() {
        ...
        java.util.List<com.github.msl521.met.domain.Payment> result = com.github.msl521.met.domain.Payment.findPaymentEntries(0, (int) count);
    ...
    public void PaymentIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyPayment(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        com.github.msl521.met.domain.Payment merged =  obj.merge();
        obj.flush();
    ...
    public void PaymentIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Payment' failed to initialize correctly", dod.getRandomPayment());
        com.github.msl521.met.domain.Payment obj = dod.getNewTransientPayment(Integer.MAX_VALUE);
    ...
    public void PaymentIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Payment' with identifier '" + id + "'", com.github.msl521.met.domain.Payment.findPayment(id));
    }
